  ...
  <FullScreenLayout>
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      ...
      >
                  ...
                  <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <input
                        ...
                        class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-red-300 focus:outline-hidden focus:ring-3 focus:ring-red-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-red-800"
                      />
                    </div>
                    <!-- Last Name -->
                    <div class="sm:col-span-1">
        ...
        <div
          class="relative items-center hidden w-full h-full lg:w-1/2 bg-gradient-to-b from-white to-red-600 dark:from-gray-100 dark:to-red-700 lg:grid"
        >
          <div class="flex items-center justify-center z-1">
            <common-grid-shape />
            <div class="flex flex-col items-center max-w-xs">
              <RouterLink :to="'/'" class="block mb-4">
                <img src="/images/logo/laravel.svg" alt="Laravel Logo" width="200" height="50" />
              </RouterLink>
              <p class="text-center text-gray-700 dark:text-gray-800">
                Framework web moderno para aplicaciones PHP
              </p>
            </div>
          </div>
        </div>
